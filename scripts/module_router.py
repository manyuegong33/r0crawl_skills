...
import argparse
rules={"apk":["android-static-analysis","android-unpacking-and-dumping","dex-memory-dump"],"frida":["frida-dynamic-analysis","frida-anti-detection-analysis"],"javascript":["js-hook-engineering","js-deobfuscation","browser-runtime-tracing"],"sign":["web-signature-analysis","crypto-dataflow-analysis"],"pcap":["protocol-reconstruction","websocket-grpc-analysis"],"malware":["malware-triage","malware-dynamic-analysis"],"dump":["memdumper-artifact-validation","dump-fix-rebuild"],"syscall":["syscall-filter-evidence","direct-syscall-analysis"],"ctf":["ctf-reversing","ctf-reverse-pivot-control","ctf-key-recovery"],"pyinstaller":["python-frozen-app-reversing","cpython-runtime-introspection"],"pyc":["python-frozen-app-reversing","cpython-runtime-introspection"],"marshal":["python-frozen-app-reversing","cpython-runtime-introspection"]}
