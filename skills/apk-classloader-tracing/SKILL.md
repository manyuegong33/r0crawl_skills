---
name: apk-classloader-tracing
description: |
  Beginner-friendly workflow for DexClassLoader, PathClassLoader, split APK, dynamic feature, plugin, and secondary payload tracing. Extracts general methods and evidence practices without depending on any author, private repository, personal path, secret, or branded prompt. Use when a reverse-engineering task needs reliable observation, loader analysis, runtime evidence, dump validation, crash attribution, tool setup, or reproducible reporting.
---

# DexClassLoader, PathClassLoader, split APK, dynamic feature, plugin, and secondary payload tracing
