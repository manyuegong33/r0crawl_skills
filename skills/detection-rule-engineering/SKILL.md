...
description: |
  Beginner-friendly reverse-engineering workflow for Detection Rule Engineering. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
---
