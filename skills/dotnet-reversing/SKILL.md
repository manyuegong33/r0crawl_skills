...
description: |
  Beginner-friendly reverse-engineering workflow for Dotnet Reversing. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
---
