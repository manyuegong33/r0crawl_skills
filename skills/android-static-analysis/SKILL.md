...
description: |
  Beginner-friendly reverse-engineering workflow for Android Static Analysis. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
---
