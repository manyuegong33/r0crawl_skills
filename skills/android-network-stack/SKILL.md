---
name: android-network-stack
description: |
  Beginner-friendly reverse-engineering workflow for Android Network Stack. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
---
