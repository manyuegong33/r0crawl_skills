---
name: browser-env-emulation
description: |
  Beginner-friendly reverse-engineering workflow for Browser Env Emulation. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
---
