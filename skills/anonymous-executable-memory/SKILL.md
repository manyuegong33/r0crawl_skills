---
name: anonymous-executable-memory
description: |
  Beginner-friendly reverse-engineering workflow for Anonymous Executable Memory. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
---
