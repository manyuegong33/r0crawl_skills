---
name: dexfixer-reconstruction
description: |
  Beginner-friendly workflow for DEX extraction and repair: header, checksum, map list, multi-dex, oat, odex, vdex, and decompiler validation. Extracts general methods and evidence practices without depending on any author, private repository, personal path, secret, or branded prompt. Use when a reverse-engineering task needs reliable observation, loader analysis, runtime evidence, dump validation, crash attribution, tool setup, or reproducible reporting.
---

# DEX extraction and repair: header, checksum, map list, multi-dex, oat, odex, vdex, and decompiler validation
