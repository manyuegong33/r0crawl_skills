---
name: cross-platform-re-lab
description: |
  Beginner-friendly workflow for Windows, Linux, and macOS host differences, paths, ABI, tool discovery, and reproducible lab setup. Extracts general methods and evidence practices without depending on any author, private repository, personal path, secret, or branded prompt. Use when a reverse-engineering task needs reliable observation, loader analysis, runtime evidence, dump validation, crash attribution, tool setup, or reproducible reporting.
---

# Windows, Linux, and macOS host differences, paths, ABI, tool discovery, and reproducible lab setup
