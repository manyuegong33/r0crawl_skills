---
name: cloud-api-reversing
description: |
  Beginner-friendly reverse-engineering workflow for Cloud Api Reversing. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
---
