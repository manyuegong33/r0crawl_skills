---
name: anti-hook-artifact-analysis
description: |
  Beginner-friendly workflow for Detect and classify instrumentation artifacts in maps, threads, modules, file descriptors, and timing. Extracts general methods and evidence practices without depending on any author, private repository, personal path, secret, or branded prompt. Use when a reverse-engineering task needs reliable observation, loader analysis, runtime evidence, dump validation, crash attribution, tool setup, or reproducible reporting.
---

# Detect and classify instrumentation artifacts in maps, threads, modules, file descriptors, and timing
