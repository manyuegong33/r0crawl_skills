---
name: ast-program-analysis
description: |
  Beginner-friendly reverse-engineering workflow for Ast Program Analysis. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
---
